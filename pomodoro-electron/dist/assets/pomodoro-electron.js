...
define('pomodoro-electron/controllers/testing', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    ...
    selected: _ember['default'].observer('selectedItem', function () {
...
define("pomodoro-electron/templates/components/color-option", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "XpSwHKZP", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"id\",\"co-test-block\"],[\"dynamic-attr\",\"style\",[\"unknown\",[\"style\"]],null],[\"static-attr\",\"class\",\"color-option-block\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"color\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/components/color-option.hbs" } });
});
...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ABJtHNqi", "block": "{\"statements\":[[\"block\",[\"dropdown-list\"],null,[[\"selectedItem\",\"items\"],[[\"get\",[\"selectedItem\"]],[\"get\",[\"colors\"]]]],0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"color\",\"value\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"color\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+61a4b10b"});
}
