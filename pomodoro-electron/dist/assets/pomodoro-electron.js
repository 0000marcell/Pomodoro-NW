...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "10yT8FWZ", "block": "{\"statements\":[[\"block\",[\"dropdown-list\"],null,[[\"items\"],[[\"get\",[\"colors\"]]]],0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"color\",\"value\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"color\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+510ed4ce"});
}
