  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    searchResults: _ember['default'].observer('search', function () {
      ...
      _ember['default'].run.later(this, function () {
        ...
        var result = _this.get('model.data.tasks').filter(function (item) {
  ...
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return _ember['default'].RSVP.hash({
        data: _pomodoroElectronRoutesData['default'],
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+3b792399"});
}
