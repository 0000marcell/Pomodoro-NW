  ...
  exports['default'] = _ember['default'].Route.extend({
    ...
    actions: {
      ...
      deleteTask: function deleteTask(task) {
        ...
        this.set('dialogCB', function (val) {
...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "yhZYPBNk", "block": "{\"statements\":[[\"block\",[\"pop-dialog\"],null,[[\"confirm\",\"showDialog\",\"title\"],[[\"get\",[\"dialogCB\"]],[\"get\",[\"showDialog\"]],\"Testing\"]],0],[\"open-element\",\"button\",[]],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"showDialog\"],null],null],[\"flush-element\"],[\"text\",\"\\n  show\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Are you sure you wanna delete ?\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
