...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "9UWkIF1C", "block": "{\"statements\":[[\"block\",[\"dropdown-list\"],null,[[\"selected\",\"items\"],[[\"get\",[\"selected\"]],[\"get\",[\"colors\"]]]],0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"append\",[\"helper\",[\"color-option\"],null,[[\"color\"],[[\"get\",[\"color\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[\"color\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
