...
define('pomodoro-electron/components/color-form', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
...
define('pomodoro-electron/components/dropdown-list', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    didReceiveAttrs: function didReceiveAttrs() {
      ...
      if (this.get('items')) {
        this.set('selectedItem', this.get('items').objectAt(0));
        this.set('selection', this.get('items').filter(function (item) {
          return item.id !== _this.get('items').objectAt(0).id;
        }));
      }
    },
    actions: {
  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    setLeftPanelModel: function setLeftPanelModel(item) {
      ...
      if (this.get('listMode') === 'tasks') {
        obj = {
          name: 'task-form',
          mode: item.name ? 'Edit' : 'New',
          tags: this.get('model-tags'),
          model: item.name ? item : this.get('newTask'),
          saveAction: item.name ? 'editTask' : 'createTask',
        ...
        obj = {
          ...
          model: item.name ? item : this.get('newTag'),
          saveAction: item.name ? 'editTag' : 'createTag',
        ...
        obj = {
          name: 'color-form',
          mode: item.name ? 'Edit' : 'New',
          model: item.name ? item : this.get('newColor'),
          saveAction: item.name ? 'editColor' : 'createColor'
        };
      }
...
define("pomodoro-electron/templates/components/color-form", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "vScBfC+M", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"color-form-header\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"mode\"]],false],[\"text\",\" Color\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"input\"],null,[[\"type\",\"value\"],[\"text\",[\"get\",[\"color\",\"name\"]]]]],false],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"input\"],null,[[\"type\",\"value\"],[\"text\",[\"get\",[\"color\",\"value\"]]]]],false],[\"text\",\"\\n\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"button-primary\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"saveColor\",[\"get\",[\"color\"]]],null],null],[\"flush-element\"],[\"text\",\"Save\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/components/color-form.hbs" } });
});
...
define("pomodoro-electron/templates/components/info-card", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "JcPtxz+H", "block": "{\"statements\":[[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"title\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/components/info-card.hbs" } });
});
...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "by2IjsHT", "block": "{\"statements\":[[\"append\",[\"helper\",[\"component\"],[[\"get\",[\"componentName\"]]],[[\"title\"],[\"something\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+972f7b40"});
}
