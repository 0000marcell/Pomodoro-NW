  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    searchResults: _ember['default'].observer('search', function () {
      ...
      _ember['default'].run.later(this, function () {
        ...
        var result = _this.get('tasks').filter(function (item) {
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+495c995b"});
}
