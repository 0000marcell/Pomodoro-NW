...
define('pomodoro-electron/components/sidenav-list', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    didReceiveAttrs: function didReceiveAttrs() {
      console.log('list mode: ', this.get('listMode'));
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+ce59d913"});
}
