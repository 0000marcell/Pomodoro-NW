...
define('pomodoro-electron/components/sidenav-list', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    didInsertElement: function didInsertElement() {
      var listMode = this.get('listMode');
    ...
    searchResults: _ember['default'].observer('search', function () {
      ...
      _ember['default'].run.later(this, function () {
        ...
        var result = _this.get('model').filter(function (item) {
    ...
    actions: {
      ...
      showLeftPanel: function showLeftPanel() {
        ...
        if (item) {
          this.get('model.state.selectedItem', item);
        } else {
          this.get('model.state.selectedItem', null);
        }
      },
...
define("pomodoro-electron/templates/components/tasks-sidepanel", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "W07jTucr", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-overlay\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"overlayClick\"],null],null],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-side column\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-side-header\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"showLeftPanel\"],null],null],[\"flush-element\"],[\"text\",\"\\n        \"],[\"append\",[\"helper\",[\"fa-icon\"],[\"chevron-left\"],null],false],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-side-body row\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-side-body-container\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"eq\"],[[\"get\",[\"mode\"]],\"editTask\"],null]],null,8,7],[\"text\",\"      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"tasks-sidepanel-aside\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"get\",[\"showTasksList\"]]],null,1,0],[\"text\",\"    \"],[\"open-element\",\"button\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"showLeftPanel\"]],[\"flush-element\"],[\"text\",\"show\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"      \"],[\"append\",[\"helper\",[\"sidenav-list\"],null,[[\"showCreate\",\"showEditTask\",\"showCreateTag\",\"model\",\"state\"],[[\"helper\",[\"action\"],[[\"get\",[null]],\"showCreateTag\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"showEditTag\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"showCreateTag\"],null],[\"get\",[\"model\",\"storage\",\"tags\"]],[\"get\",[\"model\",\"storage\",\"state\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"      \"],[\"append\",[\"helper\",[\"sidenav-list\"],null,[[\"showCreate\",\"showEdit\",\"showCreate\",\"model\",\"state\"],[[\"helper\",[\"action\"],[[\"get\",[null]],\"showCreateTask\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"showEditTask\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"showCreateTask\"],null],[\"get\",[\"model\",\"storage\",\"tasks\"]],[\"get\",[\"model\",\"storage\",\"state\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"append\",[\"helper\",[\"tag-form\"],null,[[\"mode\",\"saveTag\",\"tag\"],[\"edit\",[\"helper\",[\"route-action\"],[\"editTag\"],null],[\"get\",[\"newTag\"]]]]],false],[\"text\",\"\\n        \"]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"helper\",[\"eq\"],[[\"get\",[\"mode\"]],\"editTag\"],null]],null,2]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"append\",[\"helper\",[\"tag-form\"],null,[[\"mode\",\"saveTag\",\"tag\"],[\"create\",[\"helper\",[\"route-action\"],[\"createTag\"],null],[\"get\",[\"newTag\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"helper\",[\"eq\"],[[\"get\",[\"mode\"]],\"createTag\"],null]],null,4,3]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"append\",[\"helper\",[\"task-form\"],null,[[\"mode\",\"saveTask\",\"task\"],[\"create\",[\"helper\",[\"route-action\"],[\"createTask\"],null],[\"get\",[\"newObj\"]]]]],false],[\"text\",\" \\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"helper\",[\"eq\"],[[\"get\",[\"mode\"]],\"createTask\"],null]],null,6,5]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"append\",[\"helper\",[\"task-form\"],null,[[\"mode\",\"saveTask\",\"task\"],[\"edit\",[\"helper\",[\"route-action\"],[\"editTask\"],null],[\"get\",[\"selectedTask\"]]]]],false],[\"text\",\" \\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/components/tasks-sidepanel.hbs" } });
});
...
define("pomodoro-electron/templates/testing", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "0MXo7zyT", "block": "{\"statements\":[[\"append\",[\"helper\",[\"sidenav-list\"],null,[[\"model\",\"showLeftPanel\",\"listMode\"],[[\"get\",[\"model\"]],[\"get\",[\"showLeftPanel\"]],[\"get\",[\"listMode\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pomodoro-electron/templates/testing.hbs" } });
});
...
if (!runningTests) {
  require("pomodoro-electron/app")["default"].create({"name":"pomodoro-electron","version":"0.0.0+2dc2533c"});
}
